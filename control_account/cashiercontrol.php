...
<head>
    ...
    <title>AFYA BORA || Cashier Control</title>
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">All Cashier Accounts</h1>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Cashier Accounts</h6>
                        </div>
                        <div class="card-body">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
    ...
    $delete_sql = "DELETE FROM cashier_users WHERE id = $id";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>
                <form method="post" onsubmit="return confirm(\'Are you sure you want to delete this record?\')">
                    ...
                    <button class="btn btn-primary" type="button" onclick="location.href=\'../cashier/index.php\'">Login</button> 
