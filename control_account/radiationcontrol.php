...
<head>
    ...
    <title>AFYA BORA || Radiation Control</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">All Radiation Accounts</h1>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Radiation Accounts</h6>
                        </div>
                        <div class="card-body">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
    ...
    $delete_sql = "DELETE FROM radiation_users WHERE id = $id";
...
$sql = "SELECT * FROM radiation_users";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>
                <form method="post" onsubmit="return confirm(\'Are you sure you want to delete this record?\')">
                    ...
                    <button class="btn btn-primary" type="button" onclick="location.href=\'../radiation/index.php\'">Login</button> 
