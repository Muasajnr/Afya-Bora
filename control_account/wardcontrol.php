...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">All Ward Accounts</h1>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ward Accounts</h6>
                        </div>
                        <div class="card-body">
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>
                <form method="post" onsubmit="return confirm(\'Are you sure you want to delete this record?\')">
                    ...
                    <button class="btn btn-primary" type="button" onclick="location.href=\'../ward/index.php\'">Login</button> 
