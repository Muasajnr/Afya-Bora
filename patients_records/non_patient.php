...
<head>
    ...
    <title>AFYA BORA || Non-Patient</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Non-Patients</h6>
                            </div>
                            <div class="card-body">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
    ...
    // SQL query to delete the record from the visitors table
...
// SQL query to select data from the visitors table where position is 'nonpatient'
$sql = "SELECT * FROM visitors WHERE position = 'nonpatient'";
$result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<th>Age</th>";
    echo "<th>Role/Title</th>";
    echo "<th>Visit Purpose</th>";
    echo "<th>Time In</th>";
    echo "<th>Time Out</th>";
    echo "<th>Actions</th>"; // Added for delete button
    echo "</tr>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Add delete button to delete the corresponding row
        echo "<td>";
        echo '<form method="post" onsubmit="return confirm(\'Are you sure you want to delete this record?\')">';
        echo '<input type="hidden" name="delete_id" value="' . $row['id'] . '">';
        echo '<button type="submit" class="btn-danger" name="delete">Delete</button>';
        echo "</form>";
        echo "</td>";
        echo "</tr>";
        $count++;
