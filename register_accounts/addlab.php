<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
        ...
        if (!empty($first_name) && !empty($last_name) && !empty($email) && !empty($password)) {
            ...
            $insert_sql = "INSERT INTO lab_users (first_name, last_name, email, password) VALUES ('$first_name', '$last_name', '$email', '$password')";
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create a Lab Account!</h1>
                            </div>
